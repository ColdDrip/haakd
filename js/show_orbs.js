	  ...
	  console.log(dragging);
		...
		function colors(orb_data,type) {
			...
			var emo_color =
			{
				...
				"Surprise":["0px 0px 30px #fefcea","radial-gradient(ellipse at center, #fefcea 0%, #fefcea 40%,#fac8ae 65%, #fac8ae 100%)"],
				...
				"Dreamtime":["0px 0px 30px #000000","#ffffff url(images/abstract2.jpg))"]
			}
			if (type="normal"){
				for (h in orb_data) {
